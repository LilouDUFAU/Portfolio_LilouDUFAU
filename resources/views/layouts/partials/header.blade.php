<div class="container mx-auto flex items-center justify-between relative">
    ...
    <a href="#" class="text-gray-300 hover:text-teal-500">
        <svg width="61" height="44" viewBox="0 0 61 44" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {{-- navbar (desktop) --}}
    <nav class="hidden lg:flex justify-center space-x-6 border-2 border-solid border-teal-500 rounded-full p-2">
